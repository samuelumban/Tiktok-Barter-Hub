...
export const Admin: React.FC<AdminProps> = ({ user }) => {
    ...
    const handleDeleteSong = (songId: string) => {
        if (window.confirm("Yakin ingin menghapus lagu ini?")) {
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-white p-4 rounded shadow border-l-4 border-green-500">
                    <div className="text-gray-500 text-sm">Total Lagu</div>
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200">
                    <h3 className="font-bold text-black">Monitor User</h3>
                </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-200 text-black">
                            {allSongs.length === 0 ? (
                                <tr>
                                    <td colSpan={5} className="px-6 py-4 text-center text-gray-500">Tidak ada lagu ditemukan.</td>
                                </tr>
                            ) : (
                                allSongs.map(s => (
                                    <tr key={s.id}>
